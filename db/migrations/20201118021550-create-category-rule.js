...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    await queryInterface.createTable('category_rules', {
      ...
      categoryId: { type: Sequelize.UUID, references: { model: 'categories', key: 'id' }, field: "category_id", allowNull: true },
      isTransfer: { type: Sequelize.BOOLEAN, field: "is_transfer" },

      field:  { type: Sequelize.STRING, isIn: [["merchant", "notes", "amount"]] },
      type:   { type: Sequelize.STRING, isIn: [["regex", "numeric", "csv_field_regex"]] },
